...
<div id="page" class="container">
	...
	<div id="main">
		...
		<div id="welcome">
			<div class="title">
				<h2><font color="#202020">~宿舍借用申請狀況~</font></h2>
			</div>
		</div>
		<form action="#" method="post">
<select name="status1" size="1">
...
<?php
$No=$_GET["No"];
if($_POST["status1"]=="not"){
	$x="未處理";
}elseif($_POST["status1"]=="ing"){
	$x="處理中";
}elseif($_POST["status1"]=="fin"){
	$x="已處理";
}
...
$SQLCreate="UPDATE activitybor SET 借用狀況='$x' WHERE $No=No";
...
if($result)
	header("Location:manaborrow.php");
