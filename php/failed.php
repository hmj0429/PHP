...
<div id="page" class="container">
	<div id="header">
		...
		<div id="menu">
			<ul>
				<li class="current_page_item"><a href="#" accesskey="1" title=""><font color="white">首頁</font></a></li>
				<li><a href="#" accesskey="2" title="">維修申請</a></li>
				<li><a href="#" accesskey="3" title="">借用申請</a></li>
				<li><a href="#" accesskey="4" title="">討論區</a></li>
	...
	<div id="main">
		...
		echo "<font color=black font size=18pt>"."登入失敗!"."<br/>"."請重新登入~"."<br/>"."請按登出鍵重新登入"."<br/>"."</font>";
		}else{
		echo "非法登入喔喔喔<br/>";
