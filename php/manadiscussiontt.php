...
if($result=mysqli_query($link,$SQL)){
	while($row=mysqli_fetch_assoc($result)){
		...
		echo "<td width=6% align=center bgcolor=#2980b9>"."標題"."</td>"."<td width=16% align=center bgcolor=#FFF>".$row["標題"]."</td>"."<td width=6% align=center bgcolor=#FFF>"."<a href='manadiscussiondeltit.php?No=".$row['No']."'>刪除</a>"."</td>";
		echo "</tr>";
		echo "<tr style=line-height: 300%>";
		echo "<td width=6% align=center bgcolor=#2980b9>"."發文時間"."</td>"."<td width=16% align=center bgcolor=#FFF>".$row['time']."</td>"."<td width=6% align=center bgcolor=#FFF>"."</td>";

		echo "<tr style=line-height: 300%>";
		echo "<td width=6% align=center bgcolor=#2980b9>"."內容"."</td>"."<td width=16% align=center bgcolor=#FFF>".$row['留言']."</td>"."</td>"."<td width=6% align=center bgcolor=#FFF>"."<a href='manadiscussionttresultit.php?No=".$row['No']."'>修改</a>"."</td>";
		echo "</tr>";
	}
}
echo "</table>";
...
echo "<table border=0 cellspacing=2 bgcolor=#202020 width=100% style=font-weight:bold; font-size: 13pt; font-color:black>";
echo "<tr style=line-height: 300%>";
		echo "<td width=6% align=center bgcolor=#2980b9>"."姓名"."</td>"."<td width=36% align=center bgcolor=#2980b9>"."留言"."</td>"."<td width=6% align=center bgcolor=#2980b9>"."留言時間"."</td>"."<td width=6% align=center bgcolor=#2980b9>"."修改"."</td>"."<td width=6% align=center bgcolor=#2980b9>"."刪除"."</td>";
		echo "</tr>";
echo "<br/><br/>";
...
if($result=mysqli_query($link,$SQL)){
	while($row=mysqli_fetch_assoc($result)){
		echo "<tr style=line-height: 300%>";
		echo "<td width=6% align=center bgcolor=#FFF>".$row["姓名"]."</td>"."<td width=36% align=center bgcolor=#FFF>".$row["留言"]."</td>"."<td width=16% align=center bgcolor=#FFF>".$row["time"]."</td>"."<td width=16% align=center bgcolor=#FFF>"."<a href='manadiscussionttresult.php?No=".$row['No']."'>修改</a>"."</td>".
		"<td width=16% align=center bgcolor=#FFF>"."<a href='manadiscussiondel.php?No=".$row['No']."'>刪除</a>"."</td>";
		echo "</tr>";
	}
}
echo "</table>";
...
echo"<hr/>";
echo"<br/>";
echo"<form action='manadiscussiontt.php' method='POST'>";
...
echo"<input type='submit' value='確定送出' style='font-size:18px;'<a href='manadiscussiontt.php'></a>";
echo"</form>";
mysqli_close($link);
