...
$SQLDelete="DELETE FROM activityrp WHERE No=$No";
...
echo "<tr><td bgcolor='#FFF'>編號</td><td>姓名</td><td bgcolor='#FFF'>學號</td><td>宿舍房號</td><td bgcolor='#FFF'>聯絡電話</td><td>維修地點</td><td bgcolor='#FFF'>方便維修時間</td><td>故障問題描述</td><td bgcolor='#FFF'>維修狀況</td><td bgcolor='#FFF'>修改</td><td bgcolor='#FFF'>刪除</td></tr>";

if($result=mysqli_query($link,$SQL)){
	while($row=mysqli_fetch_assoc($result)){
		echo "<tr>";
		echo "<td bgcolor='#FFF'>".$row["No"]."</td>"."<td>".$row["姓名"]."</td>"."<td bgcolor='#FFF'>".$row["學號"]."</td>"."<td>".$row["宿舍棟別"]."</td>"."<td bgcolor='#FFF'>".$row["聯絡電話"]."</td>"."<td>".$row["報修地點"]."</td>"."<td bgcolor='#FFF'>".$row["方便的時間"]."</td>"."<td>".$row["故障問題描述"]."</td>";
		echo "<td bgcolor='#FFF'>".$row["維修狀況"]."</td>";
		echo "<td bgcolor=#FFF>"."<a href='manarepairupdate.php?No=".$row['No']."'>修改</a>"."</td>"."<td bgcolor=#FFF>"."<a href='manarepair.php?No=".$row['No']."'>刪除</a>"."</td>";
		echo "</tr>";
		}
    }
