...
<div id="page" class="container">
	<div id="header">
		...
		<div id="menu">
			<ul>
				...
				<li class="current_page_item"><a href="mana.php" accesskey="5" title=""><font color="white">功能使用狀況</font></a></li>
	...
	<div id="main">
		...
		<div id="featured">
			<div class="marqee">
				<ul>
					<h1><font color="white" font size="6em">網頁使用狀況</font></h1>
				</ul>
			</div>
		</div>
		<?php
		...
		session_start();
		echo "<font color='black';font size='7em'>公佈欄使用次數:".$_SESSION["adm"]."次"."<br/>";
		echo "維修申請使用次數:".$_SESSION["rep"]."次"."<br/>";
		echo "借用申請使用次數:".$_SESSION["b"]."次"."<br/>";
		echo "討論區使用次數:".$_SESSION["dis"]."次"."</font>";
